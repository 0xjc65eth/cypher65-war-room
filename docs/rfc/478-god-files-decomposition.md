...
**A meta de ~4.000 linhas é atingida no PR 9** (com os PRs 6 e 7 executados, o PR 8 para em ~4.320: 5.243 − 923). O residual ainda tem domínios extraíveis — inclusive um PR 10 natural de **Dashboard/`render()`** (R5+R6+R8+R18+R24+R31 ≈ 1.096) — mas eles ficam **fora da meta**; a lista acima é o que fecha o objetivo.
...
|---|---|---|
| Frontend | 1, 1b, 2, 2b, 3, 4a, 4b (+ limpeza #525), 5 (#529), 6 (#540) e 7 (#542) | **8, 9** (§3.3) |

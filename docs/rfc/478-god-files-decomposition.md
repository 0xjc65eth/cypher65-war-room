...
| **8** | Billing/Auth | R1 | ✅ **#545** (PR #546) — **924 linhas** (linhas 1–924) para `static/src/38-billing-auth.js` (969 com cabeçalho), que entra **ANTES** do 40 | **4.320** | 1 (`window.openUpgradeModal = …`) |

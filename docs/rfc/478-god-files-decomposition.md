...
| — | **residual** — Dashboard (`render()`/gráficos/HUD/overview/painéis), Docs, Settings, Export, Braiins buy, AI Chat/Operator, Theme, primitivas DOM, shell (sidebar/módulos), `boot()` | R2+R4+R5+R6+R8+R14+R15+R17+R18+R19+R21+R24+R25+R27+R28+R29+R30+R31 | — | **3.292** | — |
...
O residual ainda tem domínios extraíveis — inclusive um PR 10 natural de **Dashboard/`render()`** (R5+R6+R8+R18+R24+R31 ≈ 1.096) — mas eles ficam **fora da meta**; a lista acima é o que fecha o objetivo.

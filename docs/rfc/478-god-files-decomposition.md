...
**A meta de ~4.000 linhas é atingida no PR 9** (com o PR 6 executado, os PRs 7–8 param em ~4.319: 5.877 − 635 − 923). O residual ainda tem domínios extraíveis — inclusive um PR 10 natural de **Dashboard/`render()`** (R5+R6+R8+R18+R24+R31 ≈ 1.096) — mas eles ficam **fora da meta**; a lista acima é o que fecha o objetivo.

...
function renderAccount(acct) {
  ...
  function renderSettingsForm() {
    ...
    const order = ['cost_mode','rental_usd_per_th_day','power_watts','power_kwh_usd','btc_block_reward','btc_avg_tx_fee','pool_fee_pct','orphan_rate_pct','active_currency','active_fiat','stale_share_minutes','hashrate_drop_pct','webhook_url','webhook_min_severity','rental_pl_alert_pct','rental_pl_alert_window_hours','rental_market_overpay_pct','rental_market_arb_pct','rental_market_arb_cooldown_hours','rental_reco_worse_alert','rentals_min_delivery_pct','rental_auto_blacklist_min_samples','rental_auto_blacklist_grade','show_test_alerts','mrr_api_key','mrr_api_secret','braiins_api_key'];

...
# ── Snapshot assembly (RFC #478 · PR B3) ─────────────────────────────────────
# `_build_snapshot`, a cache global e a camada de fetchers saíram daqui para
# services/snapshot_assembly.py. Os nomes seguem re-exportados porque app.py e
# tests/ importam deles. ATENÇÃO: o código resolve os nomes nos globals DO
# MÓDULO NOVO — `monkeypatch.setattr(services.user_polling, "_fetch_json", …)`
# não intercepta mais nada; use `services.snapshot_assembly`.
from services.snapshot_assembly import (  # noqa: F401 — re-export
    BTC_PRICE_CACHE_TTL,
    FETCH_BACKOFF_BASE,
    FETCH_MAX_RETRIES,
    GLOBAL_CACHE_TTL,
